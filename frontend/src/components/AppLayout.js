        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-2 px-4 py-3 sm:gap-4 sm:px-6">
          ...
          >
            ...
            <span className="font-display text-lg font-bold tracking-tight text-stone-900">
              ...
              <span className="text-amber-600">Barokah</span>
              <span className="ml-1 hidden text-xs font-sans font-semibold uppercase tracking-widest text-amber-700/70 sm:inline">
                Telur
              </span>
            </span>
          </Link>
          ...
          <nav className="flex shrink-0 items-center gap-0.5 sm:gap-2">
            {NAV.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={cn(
                    "flex items-center gap-1.5 rounded-full px-2.5 py-2 text-sm font-semibold transition-all duration-300 sm:px-3",
                    active
            ...
            <Link
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full text-stone-400 transition-colors hover:bg-amber-500/10 hover:text-amber-700"
            >
